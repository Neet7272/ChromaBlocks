...
IL_003c_1:
			{
				...
				NullCheck(L_25);
				VirtualActionInvoker1< uint8_t >::Invoke(38, L_25, L_26);
...
IL_0056_1:
			{
				...
				uint8_t L_35 = V_2;
				NullCheck(L_34);
				VirtualActionInvoker1< uint8_t >::Invoke(38, L_34, L_35);
...
IL_006f_1:
			{
				...
				NullCheck(L_38);
				VirtualActionInvoker1< uint8_t >::Invoke(38, L_38, L_42);
			}
...
IL_007c_1:
			...
			}
			{
				...
				L_47 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(42, L_46);
				V_4 = L_47;
				goto IL_0096;
			}
		}
...
IL_0010:
	{
		...
		Dictionary_2__ctor_m2E38673D42B20080CBC896ECEA1386CC9428D78F(L_5, ((int32_t)(((RuntimeArray*)L_3)->max_length)), L_4, Dictionary_2__ctor_m2E38673D42B20080CBC896ECEA1386CC9428D78F_RuntimeMethod_var);
		V_1 = L_5;
		V_2 = 0;
		goto IL_003a;
	}
...
IL_0022:
	{
		...
		String_t* L_10;
		L_10 = UnityWebRequest_GetResponseHeader_m9AC0E1BB43CE0469BC7FE865B3D9B2C4198DDF03(__this, L_9, NULL);
		V_3 = L_10;
		...
		String_t* L_16 = V_3;
		NullCheck(L_11);
		Dictionary_2_Add_mC78C20D5901C87AAC38F37C906FAB6946BDE5F13(L_11, L_15, L_16, Dictionary_2_Add_mC78C20D5901C87AAC38F37C906FAB6946BDE5F13_RuntimeMethod_var);
		int32_t L_17 = V_2;
...
IL_0014:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(WWWTranscoder_t551AAF7200BB7381823C52321E9A60A9EE63641B_il2cpp_TypeInfo_var);
		String_t* L_6;
		L_6 = WWWTranscoder_DataEncode_mF60F56E3960A5764DCAB037C450805D94EA35194(L_4, L_5, NULL);
		V_1 = L_6;
		Encoding_t65CDEF28CF20A7B8C92E85A4E808920C2465F095* L_7;
		...
		L_14 = UnityWebRequest_get_uploadHandler_mF92ED2E0410E7F720B8775B467CFD86B60909CF5_inline(L_13, NULL);
		NullCheck(L_14);
		UploadHandler_set_contentType_mEFF2D2512996DFFF2BFC013388B702078BDC73F3(L_14, _stringLiteral14B6DF3349D302FD20ED0B3BD448C2045066E9BE, NULL);
		return;
	}
}
